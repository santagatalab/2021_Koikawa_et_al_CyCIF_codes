...
%                 Results.MedianNucSign(startcell:endcell,i3) = cellfun(@std,{Nuclei_stats.PixelValues});
%                 Results.MedianCytSign(startcell:endcell,i3) = cellfun(@std,{Cytopl_stats.PixelValues});
