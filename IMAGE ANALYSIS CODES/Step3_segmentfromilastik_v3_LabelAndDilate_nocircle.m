function Step3_segmentfromilastik_v3_LabelAndDilate_nocircle(filename, options) 
...
%             % commented out this step where the images are filtered using
%             % an octagonal structure that is not appropriate for non-round
%             % objects
